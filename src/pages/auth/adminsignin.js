...
export default function SignIn({ initialError }) { // initialError is passed as a prop here
  ...
  const handleSubmit = async (e) => {
    ...
    setSuccess('');
    try {
      const res = await fetch('https://animeclipsbr.onrender.com/auth/adminsignin', {
        method: 'POST',
    ...
    <div className={styles.container}>
      ...
      <form className={styles.form} onSubmit={handleSubmit}>
        ...
        <div className={styles.element}>
          <label className={styles.title}>Admin Email</label>
          <input
        ...
        <div className={styles.element}>
          <label className={styles.title}>Admin Password</label>
          <input
            className={styles.input}
            type="password"
            name="password"
